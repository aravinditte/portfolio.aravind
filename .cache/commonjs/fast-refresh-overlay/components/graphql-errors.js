...
function WrappedAccordionItem({ error, open }) {
  ...
  const title =
    (error === null || error === void 0
      ? void 0
      : (_error$error = error.error) === null || _error$error === void 0
      ? void 0
  ...
  const lineNumber =
    error === null || error === void 0
      ? void 0
      : (_error$location = error.location) === null || _error$location === void 0
      ? void 0
      : (_error$location$start = _error$location.start) === null || _error$location$start === void 0
      ? void 0
      : _error$location$start.line;
  const columnNumber =
    error === null || error === void 0
      ? void 0
      : (_error$location2 = error.location) === null || _error$location2 === void 0
      ? void 0
      : (_error$location2$star = _error$location2.start) === null ||
        _error$location2$star === void 0
      ? void 0
      : _error$location2$star.column;
  let locString = ``;
...
function GraphqlErrors({ errors, dismiss }) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        hasMultipleErrors ? `Multiple` : `One`,
        ' unhandled GraphQL',
        ` `,
        hasMultipleErrors ? `errors` : `error`,
        ' found in your files. See the list below to fix ',
      ...
      /*#__PURE__*/ React.createElement(
        ...
        deduplicatedErrors.map((error, index) =>
          /*#__PURE__*/ React.createElement(WrappedAccordionItem, {
            open: index === 0,
            error: error,
