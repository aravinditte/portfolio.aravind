...
function WrappedAccordionItem({ error, open }) {
  ...
  const filePath =
    codeFrameInformation === null || codeFrameInformation === void 0
      ? void 0
      : codeFrameInformation.moduleId;
  const lineNumber =
    codeFrameInformation === null || codeFrameInformation === void 0
      ? void 0
      : codeFrameInformation.lineNumber;
  const columnNumber =
    codeFrameInformation === null || codeFrameInformation === void 0
      ? void 0
      : codeFrameInformation.columnNumber;
  const name =
    codeFrameInformation === null || codeFrameInformation === void 0
      ? void 0
      : codeFrameInformation.functionName;
  ...
  const line =
    (_res$sourcePosition = res.sourcePosition) === null || _res$sourcePosition === void 0
      ? void 0
      : _res$sourcePosition.line;
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement('div', null, filePath, ':', line),
      /*#__PURE__*/ React.createElement(
        'button',
        {
...
function RuntimeErrors({ errors, dismiss }) {
