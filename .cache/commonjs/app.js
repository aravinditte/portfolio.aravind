...
(0, _apiRunnerBrowser.apiRunnerAsync)(`onClientEntry`).then(() => {
  ...
  const renderer = (0, _apiRunnerBrowser.apiRunner)(
    ...
    undefined, // Client only pages have any empty body so we just do a normal
    // render to avoid React complaining about hydration mis-matches.
    focusEl && focusEl.children.length > 0 ? _reactDom.default.hydrate : _reactDom.default.render,
  )[0];
  ...
  if (
    ...
    const showIndicatorTimeout = setTimeout(() => {
      ...
      _reactDom.default.render(
        /*#__PURE__*/ _react.default.createElement(_indicator.Indicator, null),
        ...
        if (
          ...
          _reactDom.default.render(
            /*#__PURE__*/ _react.default.createElement(
              _loadingIndicator.LoadingIndicatorEventHandler,
              null,
            ),
            indicatorMountElement,
          );
