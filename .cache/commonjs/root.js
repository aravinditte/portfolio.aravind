...
const RouteHandler = props =>
  /*#__PURE__*/ _react.default.createElement(
    _reachRouter.BaseContext.Provider,
    {
      value: {
        baseuri: `/`,
        basepath: `/`,
...
class LocationHandler extends _react.default.Component {
  render() {
    ...
    if (real404PageResources) {
      custom404 = /*#__PURE__*/ _react.default.createElement(
...
const Root = () =>
  /*#__PURE__*/ _react.default.createElement(_reachRouter.Location, null, locationContext =>
    /*#__PURE__*/ _react.default.createElement(LocationHandler, locationContext),
  ); // Let site, plugins wrap the site e.g. for Redux.

const rootWrappedWithWrapRootElement = (0, _apiRunnerBrowser.apiRunner)(
  `wrapRootElement`,
  {
...
function RootWrappedWithOverlayAndProvider() {
  return /*#__PURE__*/ _react.default.createElement(
    _fastRefreshOverlay.default,
    null,
    /*#__PURE__*/ _react.default.createElement(
      _queryResultStore.StaticQueryStore,
      null,
